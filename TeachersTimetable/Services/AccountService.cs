...
namespace TeachersTimetable.Services
{
    ...
    {
        Task<TelegramBot_Timetable_Core.Models.TeachersUser?> CreateAccount(User telegramUser);
    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<TelegramBot_Timetable_Core.Models.TeachersUser?> CreateAccount(User telegramUser)
        {
            ...
            var user = new TelegramBot_Timetable_Core.Models.TeachersUser(telegramUser.Id, telegramUser.Username, telegramUser.FirstName,
        ...
        public async Task<bool> ChangeTeacher(User telegramUser, string? teacherName)
        {
            ...
            var update = Builders<TelegramBot_Timetable_Core.Models.TeachersUser>.Update.Set(u => u.Teacher, user.Teacher);
        ...
        public async Task UpdateNotificationsStatus(User telegramUser)
        {
            ...
            var update = Builders<TelegramBot_Timetable_Core.Models.TeachersUser>.Update.Set(u => u.Notifications, user.Notifications);
            await userCollection.UpdateOneAsync(u => u.UserId == telegramUser.Id, update);
